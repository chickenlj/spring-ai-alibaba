 ...
 * graph edges. They operate on an {@link io.agentscope.OverAllState} and can
 * optionally interact with a {@link io.agentscope.RunnableConfig}.
 *
 * <p>
 ...
 * <ul>
 * <li>{@link io.agentscope.action.NodeAction}: Represents a synchronous
 ...
 * <li>{@link io.agentscope.action.NodeActionWithConfig}: Similar to
 * {@code NodeAction}, but also accepts a
 * {@link io.agentscope.RunnableConfig} parameter, allowing for more
 * configurable node behavior at runtime.</li>
 * <li>{@link io.agentscope.action.EdgeAction}: Defines synchronous
 ...
 * <li>{@link io.agentscope.action.CommandAction}: Represents a synchronous
 * action that evaluates the agent state and a
 * {@link io.agentscope.RunnableConfig} to produce a
 * {@link io.agentscope.action.Command}. This command encapsulates both
 * potential state updates and the next node to transition to, offering a structured way
 * to define node outcomes.</li>
 * <li>{@link io.agentscope.action.AsyncNodeAction}: An asynchronous
 ...
 * <li>{@link io.agentscope.action.AsyncEdgeAction}: The asynchronous version
